<div id="createPacientForm" class="form_add relative w-4/5 h-3/4 rounded-md p-5 bg-white grid grid-cols-2 grid-rows-5 gap-4">
    ...
    <button id="btnCreatePacientForm" wire:click="save" class="save w-full block text-base rounded-md bg-green-800 p-1">Guardar </button>
</div>
